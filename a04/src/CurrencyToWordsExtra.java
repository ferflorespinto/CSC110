 ...
 * ID: V00880059
 *
 * This class CurrencyToWordsExtra 'converts' numbers to words, and outputs the number
 * the user provides in words, plus any decimal amount. This program's output
 * is the design of a cheque. This class asks for user's name, address, and recipient's
 * name in order to design the cheque and print it out. The class also prints the date
 * of when the cheque was created.
 *
 */
...
public class CurrencyToWordsExtra {
	...
	//Prints top and bottom of the cheque
	...
	//Asks the user to input his information: name, address and recipient's name
	public static String chequeInformation(double value) {
		Scanner input = new Scanner(System.in);
		String content = "";
		System.out.print("Please enter the name of the sender: ");
		String name = input.nextLine();
		System.out.print("Please enter the address of the sender: ");
		String address =  input.nextLine();
		System.out.print("Please enter the name of the recipient: ");
		String recipient = input.nextLine();
		content = printCheque(name, address, recipient, value);
		return content;

	}
	//Prints the information provided by the user
	public static String printCheque(String name, String address, String recipient, double amount) {
		separator();
		System.out.println();
		System.out.println(name);
		System.out.println(address);
		System.out.println();
		System.out.print("Pay to the order of: " + recipient);
		String len = "" + amount;
		for (int i = recipient.length(); i <= 32; i++) {
			System.out.print(" ");

		}
		System.out.print("$");
		for (int i = 1; i <= 15 - len.length(); i++) {
			System.out.print(" ");
	...
	public static void main(String[] args) {
		...
		String anotherText = chequeInformation(value);
		System.out.println(anotherText);
		String text = convertToWords(value);
		System.out.println(text);
		System.out.println("The Bank of Trump");
		System.out.println("101 Avenue of the Americas New York City, NY 10101");
		System.out.println();
		//Sets today's date, and later prints it
		Date today = new Date();
