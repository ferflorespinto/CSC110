 ...
 * ID: V00880059
 *
 * This class MineSweeperExtra consists of the famous game "MineSweeper." It works
 ...
 *
 * In addition to MineSweeper functionalities, MineSweeperExtra keeps track of the number
 * of seconds the player takes to end the game. This class also asks the user if he wants
 * to play again, or exit the program.
 */
...
public class MineSweeperExtra {
	 ...
	 */
	public static void revealGridCell(int row, int col, String[][] grid, String[][] shellGrid, long startTime) {
		if(grid[row][col] == " ") {
			if(row == 0 && col == 0) {
	...
	public static void main(String[] args) {
		...
		do {
			...
			do {
				 ...
				 */
				revealGridCell(row, col, minedGrid, shellGrid, startTime);
			...
			System.out.println("That took you " + estimatedTime + " seconds!");	
			System.out.print("Enter the number '1' if you would like to play again: ");
